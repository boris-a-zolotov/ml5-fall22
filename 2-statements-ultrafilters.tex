...
\begin{theorem}[Лося об ультрапроизведениях] % название сказали на третьей лекции
...
% Эта теорема доказывается на следующей лекции во второй половине, поэтому формулировку перенёс туда же.
